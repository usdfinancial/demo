...
import { Shield, TrendingUp, AlertTriangle, CheckCircle, Clock, DollarSign, RefreshCw, Plus, BarChart3, Activity } from 'lucide-react'
...
interface InsuranceProduct {
  id: string
  name: string
  type: 'defi' | 'smart-contract' | 'custody' | 'yield'
  description: string
  coverage: number
  premium: number
  duration: string
...
const insuranceProducts: InsuranceProduct[] = [
  {
    ...
    type: 'defi',
    description: 'Protect your DeFi investments against protocol failures and exploits',
    coverage: 100000,
    premium: 250,
    duration: '12 months',
    features: ['Protocol exploit coverage', 'Smart contract bugs', 'Governance attacks', '24/7 monitoring'],
    riskLevel: 'Medium',
    status: 'active'
  },
  {
    ...
    type: 'smart-contract',
    description: 'Coverage for smart contract vulnerabilities and failures',
    coverage: 50000,
    premium: 150,
    duration: '6 months',
    features: ['Code audit coverage', 'Bug bounty protection', 'Upgrade risks', 'Emergency response'],
    riskLevel: 'High',
    status: 'available'
  },
  {
    id: '3',
    name: 'Custody Protection',
    type: 'custody',
    description: 'Secure your assets with comprehensive custody insurance',
    coverage: 250000,
    premium: 500,
    duration: '12 months',
    features: ['Multi-sig protection', 'Key management', 'Theft coverage', 'Operational errors'],
    riskLevel: 'Low',
    status: 'active'
  },
  {
    ...
    type: 'yield',
    description: 'Protect your yield farming positions from impermanent loss',
    coverage: 75000,
    premium: 200,
    duration: '3 months',
    features: ['Impermanent loss protection', 'Pool exploit coverage', 'Token depegging', 'Liquidity risks'],
    riskLevel: 'Medium',
    status: 'available'
  }
]
...
export default function InsurancePage() {
  ...
  const claims: InsuranceClaim[] = [
    ...
    {
      id: '2',
      productName: 'Custody Protection',
      amount: 2500,
      status: 'paid',
