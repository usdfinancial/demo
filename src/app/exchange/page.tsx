      ...
      <AuthGuard>
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold mb-2">Please sign in to access Exchange</h3>
            <p className="text-muted-foreground">Connect your account to swap stablecoins and earn yield</p>
          </div>
        </div>
      </AuthGuard>
    )
